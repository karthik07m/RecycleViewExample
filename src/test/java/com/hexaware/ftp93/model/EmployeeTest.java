...
public class EmployeeTest {
  ...
  public final void testGettersSetters() throws ParseException {
    ...
    Employee obj = new Employee(3002, "Pratyusha", "pratyusha423@hexaware.com",
                    9874563214L, sdf.parse("2018-10-11"), "Trainee", 6, 2000);
    obj.setEmpId(3002);
    ...
    assertEquals(6, obj.getEmpLeaveBalance());
  ...
  public final void testEqualsHashCode() throws ParseException {
    ...
    Employee e = new Employee(3001, "Mani Karthik", "Karthik453@hexaware.com", 9956382741L, dateOfJoin, "Trainee", 2001,
        2);
    assertEquals(
        new Employee(3001, "Mani Karthik", "Karthik453@hexaware.com", 9956382741L, dateOfJoin, "Trainee", 2001, 2), e);
    assertEquals(
        new Employee(3001, "Mani Karthik", "Karthik453@hexaware.com", 9956382741L, dateOfJoin, "Trainee", 2001, 2)
            .hashCode(),
        e.hashCode());
  }
  ...
  public final void testTOString() throws ParseException {
    ...
    String exp = "empId" + e.getEmpId() + "empName" + e.getEmpName() + "empMail" + e.getEmpEmail() + "empMobileNo"
        + e.getEmpMobileNo() + "empDoj" + e.getEmpDoj() + "empdept" + e.getEmpDept() + "empleavebalance"
        + e.getEmpLeaveBalance() + "empmgrid" + e.getEmpManagerId();
